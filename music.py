...
def main():   
    img = cv2.imread("Line-1.jpg", cv2.IMREAD_GRAYSCALE)
    temp = cv2.imread("treble_1.jpg", cv2.IMREAD_GRAYSCALE)

    clef_boxes = locate_templates(img,[temp], 20,99, 0.5)
